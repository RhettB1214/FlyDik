...
/*LemLib Chassis Initializations*/
	...
	lemlib::Drivetrain drivetrain /*normal DT*/
	{
	...
	lemlib::Drivetrain rDrivtrain /*reverse DT*/
	{
		&rDrive, /*Pointer to the left drive channel*/
		&lDrive, /*Pointer to the right drive channel*/
		10.5, /*Track Width*/
		3.25, /*Wheel Diameter*/
		450, /*Wheel RPM*/
		8 /*Chase Power*/
...
void opcontrol() 
{
	...
	Gif gif("/usd/mailbox.gif", lv_scr_act());
	while(true)
	{
